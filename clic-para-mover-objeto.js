...
lib.ssMetadata = [
		{name:"clic_para_mover_objeto_atlas_1", frames: [[0,0,79,227],[81,0,49,41],[81,43,55,34],[132,0,55,10]]}
];
...
(lib.flash0ai = function() {
	this.initialize(ss["clic_para_mover_objeto_atlas_1"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(0,0,55,10);
...
p.nominalBounds = new cjs.Rectangle(0,0,49,41);


// stage content:
(lib.clicparamoverobjeto = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		*/
		...
		this.button_2.addEventListener("click", fl_ClickToPosition_2.bind(this));
	...
	// zapatos
	this.button_3 = new lib.Símbolo3();
	this.button_3.name = "button_3";
	this.button_3.setTransform(467.4,368.1);
	new cjs.ButtonHelper(this.button_3, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.button_3).wait(1));

	// camiseta
	this.button_2 = new lib.Símbolo2();
	this.button_2.name = "button_2";
	this.button_2.setTransform(462.7,233);
	...
	this.button_1.setTransform(473.4,280);
	...
	this.instance.setTransform(361,187);
...
p.nominalBounds = new cjs.Rectangle(761,487,-238.60000000000002,-73);
// library properties:
lib.properties = {
	id: '943CBC5611D91342B11A88279C043AD6',
	width: 800,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/clic_para_mover_objeto_atlas_1.png", id:"clic_para_mover_objeto_atlas_1"}
	],
	preloads: []
};
...
an.compositions['943CBC5611D91342B11A88279C043AD6'] = {
